...
class Data():
    ...
    def preprocess_train(self):
        ...
        """
        #selif.transform()     
        trainloader, image_dataset = self.preprocess_one_train_dataset()
    ...
    def preprocess_test(self):
        ...
        testloader = {key: torch.utils.data.DataLoader(
                                                dataset, 
                                                batch_size=self.batch_size,
                                                shuffle=False, 
                                                num_workers=2, 
        ...
        print('Query Sizes:', query_meta['sizes'])
        print('Gallery Sizes:', gallery_meta['sizes'])
...
def get_camera_ids(img_paths):
    ...
    for path, v in img_paths:# path는 jpg file 객체, v는 그 위의 id 폴더명
        ...
        camera_ids.append(int(camera_id[0]))
